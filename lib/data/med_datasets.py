...
def get_json_testset(args, val_transform=None):
    data_dir = args.data_path
    print(f'=> Get testset from specified json file {args.json_list}')
    datalist_json = os.path.join(data_dir, args.json_list)
...
def get_test_loader(args, batch_size, workers, val_transform=None):
    if args.dataset in ['btcv']:
        val_ds = get_json_testset(args, val_transform=val_transform)
    elif args.dataset == 'msd_brats':
        val_ds = get_msd_valset(args, 
                                workers, 
                                val_transform=val_transform,
